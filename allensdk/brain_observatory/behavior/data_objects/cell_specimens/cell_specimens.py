...
class CellSpecimens(
    ...
    def to_nwb(
        ...
        # 4. Add neuropil traces
        self._neuropil_traces.to_nwb(nwbfile=nwbfile)
    ...
    def _get_segmentation_mask_image(self, spacing: tuple) -> Image:
        ...
        mask_image = Image(data=mask_data, spacing=spacing, unit="mm")
        return mask_image
