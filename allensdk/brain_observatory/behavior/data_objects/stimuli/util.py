...
from allensdk.brain_observatory.behavior.data_files.visualcoding_sync_file import SyncFile as VCSyncFile
...
def calculate_monitor_delay_for_session(sync_file: VCSyncFile,
                            equipment: Equipment) -> float:
    """Calculates monitor delay using sync file. If that fails, looks up
    monitor delay from known values for equipment.
