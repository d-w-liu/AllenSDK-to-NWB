...
import argschema
from allensdk.brain_observatory.behavior.visualcoding_ophys_experiment import (
    VisualCodingOphysExperiment,
)
from allensdk.brain_observatory.behavior.write_nwb.visualcoding_ophys.visualcoding_utils import ( VisualCodingNWBWriter
)
from allensdk.brain_observatory.behavior.write_nwb.visualcoding_ophys.schemas import (
    VisualCodingInputSchema,
    OutputSchema,
)

class WriteVisualCodingNWB(argschema.ArgSchemaParser):
    default_schema = VisualCodingInputSchema
    ...
    def write_experiment_nwb(
        ...
        """Load and write a VisualCodingExperiment as NWB.
        ...
        path of the file.
        """
        nwb_writer = VisualCodingNWBWriter(
            nwb_filepath=str(nwb_filepath),
            session_data=ophys_experiment_metadata,
            serializer=VisualCodingOphysExperiment,
        )
...
if __name__ == "__main__":
    nwb_writer = WriteVisualCodingNWB()
    nwb_writer.run()